...
if __name__ == '__main__':
    ...
    lr_decay = False
    lr_decay_rate = 0.2
    lr_decay_freq = int(1e6)
    model_saving_dir = '/Users/winslowfan/Documents/Lectures/Sheffield/Final Dissertation/ReinforcementLearning/SAC_preTrained/'
    now = datetime.now()
    ...
    while total_steps < max_train_steps:
        ...
        while not done:
            ...
            if total_steps % save_freq == 0:
                actor_path = model_saving_dir + 'SAC_actor_{}.pth'.format(i_episode)
                critic_path = model_saving_dir + 'SAC_critic_{}.pth'.format(i_episode)
